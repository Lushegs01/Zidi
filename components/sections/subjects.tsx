...
export function SubjectCard({
  ...
  return (
    <Link
      ...
      className="group relative flex aspect-3/4 flex-col justify-end overflow-hidden rounded-lg bg-kola text-bone shadow-soft transition-shadow duration-300 hover:shadow-lift sm:aspect-4/5 lg:aspect-3/4"
    >
      {subject.image && (
        <Image
          src={subject.image}
      ...
      <div className="relative z-1 p-6 md:p-7">
        ...
        <p className="group/btn mt-5 inline-flex items-center gap-2 text-[0.9375rem] font-medium text-bone">
          <span className="relative">
            ...
            <span
              aria-hidden="true"
              className="absolute -bottom-0.5 left-0 h-px w-full origin-left scale-x-0 bg-amber transition-transform duration-300 ease-out-soft group-hover:scale-x-100"
            />
          </span>
    ...
    <Section id="subjects" size="lg" aria-labelledby="subjects-heading">
      <Container>
        ...
        <Reveal className="mt-14 md:mt-16">
          ...
          <ul className="mt-8 grid gap-px overflow-hidden rounded-lg bg-line sm:grid-cols-2 lg:grid-cols-3">
