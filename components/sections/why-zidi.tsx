      ...
      <Container>
        <div className="grid gap-14 lg:grid-cols-12 lg:gap-16">
          ...
          <div className="lg:col-span-6 lg:col-start-7 xl:col-span-6 xl:col-start-7">
            <Reveal delay={80}>
              <div className="relative overflow-hidden rounded-lg bg-kola-800">
                <Image
                  src={heritage}
            ...
            <Reveal delay={140}>
              <dl className="mt-10 grid gap-x-8 gap-y-6 sm:grid-cols-2">
                {carries.map((item) => (
                  <div key={item.word} className="border-t border-kola-600 pt-4">
                    <dt className="font-display text-[1.5rem] leading-none text-amber">
                      {item.word}
                    </dt>
